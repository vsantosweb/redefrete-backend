...
export function AuthProvier({ children }) {
    ...
    useEffect(() => {
        (async () => {
            ...
            if (token) {
                ...
                await Axios.get(process.env.NEXT_PUBLIC_URL_API_CLIENT + '/customer/auth/logged', {
    ...
    async function signIn({ email, password }: SignInCredentials) {
        ...
        const { data } = await Axios.post(process.env.NEXT_PUBLIC_URL_API_CLIENT + '/customer/auth/login', { email, password })
